...
$password = "secret";
$dbname = "kpi_mech";
$style3 = "<td style = 'wlocationth: 150px; border: 4px solid black; background-color: #ffff00; font-size: 12px; ' align='center'>";//format if StartTime exceed $limit in minutes
$style1 = "<td style = 'wlocationth: 150px; border: 4px solid black; background-color: #ff6666; font-size: 12px; ' align='center'>";//format if StartTime exceed $limit in minutes

$style2 = "<td style = 'wlocationth: 150px; border: 4px solid black; background-color: #ffffff; font-size: 12px; ' align='center'>";//format otherwise
$limit = 15;
$limit2 = 30;
...
try {
	...
	if ($result->num_rows > 0) {
		...
		//echo "<font size='30'>";
		echo "<tr><th>Cell</th><th>Assignee</th><th>BreakStartTime</th><th>StartTime</th><th>EndTime</th><th>Breakdown Type</th></tr>";
		echo "</span>";
