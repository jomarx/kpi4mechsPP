...
//	$sql = "SELECT * from mbreak_db";
		$sql = "SELECT mech_db.FirstName,mech_db.LastName,mech_db.ShortName,mech_db.dayOrNight,mbcode_db.details,task_db.StartDate,task_db.EndDate from mech_db INNER JOIN task_db ON task_db.Assignee=mech_db.empID INNER JOIN mbcode_db ON mbcode_db.id=task_db.details";
	...
	if ($result->num_rows > 0) {
		...
		//echo "<font size='30'>";
		echo "<tr><th>FirstName</th><th>LastName</th><th>ShortName</th><th>DayOrNight</th><th>Details</th><th>StartDate</th><th>EndDate</th><th>Duration</th></tr>";
		echo "</span>";
